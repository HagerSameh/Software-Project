...
public class Device extends javax.swing.JFrame {
    ...
    {
        Item I = new Item();
        I.Location = jTextField1.getText();
        I.Date = jTextField2.getText();
        I.Time = jTextField3.getText();
        I.Color = jTextField4.getText(); //model
        I.BrandName = jTextField5.getText();
        I.category = jTextField6.getText(); //type
        
        DeviceItemDB.add(I);
        
        for (int i=0 ; i< DeviceItemDB.size() ; i++)
            System.out.println(DeviceItemDB.get(i).category +DeviceItemDB.get(i).Location + DeviceItemDB.get(i).Date + DeviceItemDB.get(i).Time + DeviceItemDB.get(i).Color+ DeviceItemDB.get(i).BrandName);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean check = Device_Controller (jTextField6.getText() ,
                                                    jTextField1.getText(),
                                                    jTextField2.getText(),
                                                    jTextField3.getText(),
                                                    jTextField4.getText(),
